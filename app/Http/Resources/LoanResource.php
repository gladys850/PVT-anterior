...
class LoanResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'payable_liquid_calculated' => $this->payable_liquid_calculated,
            'bonus_calculated' => $this->bonus_calculated,
            'indebtedness_calculated' => $this->indebtedness_calculated,
            'liquid_qualification_calculated' => $this->liquid_qualification_calculated,
