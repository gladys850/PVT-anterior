...
class AffiliateController extends Controller
{
    ...
    *       "civil_status_gender": "casado",
    *       "dead": false,
    *       "defaulted": false,
    *       "cpop": false,
    *       "identity_card_ext": "678681 OR",
    *       "category": {
    *           "id": 8,
    *           "from": 29,
    *           "to": 100,
    ...
    *           "name": "ORURO",
    *           "first_shortened": "OR",
    *           "second_shortened": "ORU",
    *           "third_shortened": "ORU",
    *           "to_bank": "OR",
    *           "latitude": -17.969553496046,
    *           "longitude": -67.114743590355
    *       },
    *       "contributions": [
    *           {
    *               "id": 7551390,
    ...
    *               "breakdown_id": null,
    *               "category_id": 1,
    *               "month_year": "1981-01-01",
    *               "item": null,
    *               "type": "Planilla",
    *               "base_wage": "0.00",
    *               "seniority_bonus": "0.00",
    *               "study_bonus": "0.00",
    *               "position_bonus": "0.00",
    *               "border_bonus": "0.00",
    *               "east_bonus": "0.00",
    ...
    *               "payable_liquid": null,
    *               "quotable": "0.00",
    *               "retirement_fund": "0.00",
    *               "mortuary_quota": "0.00",
    *               "subtotal": null,
    *               "interest": null,
    *               "total": "0.00",
    *               "created_at": "2019-08-21 17:37:04",
    *               "updated_at": "2019-08-21 17:38:18",
    *               "deleted_at": null,
