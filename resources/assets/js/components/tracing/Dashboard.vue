              ...
              <v-card-text class="headline font-weight-bold">
                <v-row>
                  <v-col cols="5" class="py-0">
                    ...
                    <strong v-show="loan.borrower.length == 1"><b style="color:white">PRESTATARIO: </b></strong>
                    ...
                    <div v-for="(lenders,i) in loan.borrower" :key="i" v-show="loan.borrower.length > 1">
                      ...
                      <b style="color:white">C.I: </b>{{lenders.identity_card +' '+loan.borrower[0].city_identity_card.first_shortened}} </h6>
                    </div>
                  </v-col>
