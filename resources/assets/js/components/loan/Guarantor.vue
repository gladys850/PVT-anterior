                  ...
                  <v-flex xs12 class="px-2">
                    <fieldset class="pa-3">
                      <v-row>
                        ...
                        <v-col cols="12" md="3" class="pb-0" v-show="retroceder_meses">
                          <v-checkbox
                            v-model="ex4"
                            label="Boleta"
                            color="info"
                        ...
                        <v-col cols="12" md="2" v-show="show_ajuste">
                          <v-tooltip>
                            <template v-slot:activator="{ on }">
                              <v-btn
                                fab
...
ver()
{
     ...
     async calculator() {
      try {
         if(this.affiliate_garantor.guarantor_information==true)
        {
            ...
            this.show_data=true
            this.payable_liquid[0]+=this.payable_liquid[0]+this.monto_ajustable
  ...
  async ajuste(){
 this.toastr.error("Cree su ajuste.")
  },
   async activar()
    {
      this.clear()
    ...
    async retrocederContribusiones(){
        this.toastr.error("se retroceden boletas.")
          ...
          params:{
            city_id: this.$store.getters.cityId,
            choose_diff_month: 1,
            number_diff_month:this.cantidad_boletas,
            sortBy: ['month_year'],
            sortDesc: [1],
            per_page: 1,
            page: 1,
