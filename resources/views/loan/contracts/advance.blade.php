...
<body>
    ...
    <div class="block">
        <div class="font-semibold leading-tight text-center m-b-10 text-xs">
            CONTRATO DE PRÉSTAMO XXXXXXX-PROCEDURE-MODALITY
            <div>Nº {{ $title }}</div>
        </div>
    </div>

    <div>
        Conste en el presente contrato de préstamo de XXXXXXX-PROCEDURE-MODALITY, que al solo reconocimiento de firmas y rúbricas ante autoridad competente será elevado a instrumento público, por lo que las partes que intervienen lo suscriben al tenor de las siguientes claúsulas y condiciones:
    </div>
    <div>
        PRIMERA.- (DE LAS PARTES): Intervienen en el presente contrato, por una parte como acreedor la Mutual de Servicios al Policía (MUSERPOL), representada legalmente por el Director General Ejecutivo Cnl. XXXX-NOMBRE-CORONEL con C.I. XXXXX-LP y su Director de Asuntos Administrativos Lic. XXXX-NOMBRE-LAZO con C.I. XXXXXX-LP, que para fines de este contrato en adelante se denominará MUSERPOL con domiciliio en la Z. Sopocachi, Av. 6 de Agosto Nº 2354 y por otra parte como deudor(a) XXXXX-GENERO(el la) XXXXXX-NOMBRE-DISBURSABLE, con C.I. XXXXXXX-LP, XXXXXX-ESTADO-CIVIL, mayor de edad, hábil por derecho, natural de XXXXXXX-CITY-BIRTH, vecino de XXXXXX-CITY-IDENTITY-CARD y con domicilio especial en XXXXXX-ADDRESS, en adelante XXXXX-GENDER-denomido/a PRESTATARIO.
    </div>
    <div>
        SEGUNDA.- (DEL OBJETO): El objeto del presente contrato es el préstamo de dinero que MUSERPOL otogra al PRESTATARIO conforme a niveles de aprobación respectivos, en la suma de Bs. XXXXXXX-AMOUNT-REQUESTED (LITERAL XXXXX-AMOUNT-REQUESTES).
    </div>
    <div>
        TERCERA.- (DEL INTERÉS): El préstamo objeto del presente contrato, devengará un interés ordinario del XXXXX-CURRENT-INTEREST% anual sobre saldo deudos, el mismo que se recargará con el interés penal en caso de mora de una o más amortizaciones. Esta tasa de interés podrá ser modificada en cualquier momento de acuerdo a las condiciones financieras que adopte MUSERPOL.
    </div>
    <div>
        CUARTA.- (DEL DESEMBOLSO, DEL PLAZO Y LA CUOTA DE AMORTIZACIÓN): El desembolso del préstamo se acredita mediante comprobante escrito en el que conste el abono efectuado a favor del PRESTATARIO, o a través de una cuenta bancaria del Banco Unión a solicitud del PRESTATARIO, reconociendo ambas partes que el amparo de este procedimiento se cumple satisfactoriamente la exigencia contenida en el artículo 1331 del Código de Comercio. El plazo fijo e inprorrogable para el cumplimiento de la obligación contraida por el PRESTATARIO en virtud al préstamo otorgado es de XXXXX-LOAN-TERM meses computables a partir de la fecha de desembolso. La cuota de amortización mensual es de Bs. XXXXX-CUOTA-CALCULADORA (XXXX-LITERAL).
    </div>
    <div>
    ...
    <div>
        QUINTA.- (DE LA FORMA DE PAGO Y OTRAS CONTINGENGIAS): Para el cumplimiento estricto de la obligación (capital e intereses) el PRESTATARIO, autoriza expresamente a MUSERPOL practicar los descuentos respectivos de los haberes que percibe en forma mensual a través del Comando General de la Policía Boliviana.
    </div>
    <div>
    ...
    <div>
        SEXTA.- (DERECHOS DEL PRESTATARIO): Conforme al Artículo 29 del Reglamento de Préstamos las partes reconocen expresamente como derechos irrenunciables del PRESTATARIO, lo siguiente:
    </div>
    <div>
        <ol type="a">
    ...
    <div>
        SÉPTIMA.- (OBLIGACIONES DEL PRESTATARIO): Conforme al Artículo 30 del Reglamento de Préstamos, las partes reconocen expresamente como obligaciones del PRESTATARIO, lo siguiente:
    </div>
    <div>
        <ol type="a">
