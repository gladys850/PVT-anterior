        ...
        <table class="table-info w-100 text-center uppercase my-20">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="w-7">{{ Carbon::parse($parent_loan_payment->pay_date)->format('d/m/Y') }}</td>
                    ...
                    <td class="w-8 text-right">{{ $parent_loan_payment->voucher_treasury->code }}</td>
                ...
                <tr>
                    ...
                    <td class="w-6">{{ Carbon::parse($payment->pay_date)->format('d/m/Y') }}</td>
                    ...
                    <td class="w-8 text-right">{{ $payment->voucher_treasury->code }}</td>
