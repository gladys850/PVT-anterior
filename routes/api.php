...
Route::group([
    ...
    Route::group([
        ...
        Route::apiResource('global_parameter', 'Api\V1\LoanGlobalParameterController')->only('index', 'show', 'store', 'update', 'destroy');
        ...
        Route::group([
            ...
            Route::get('loan/{id}/history','Api\V1\LoanController@get_history');
        });
        Route::group([
