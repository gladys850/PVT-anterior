...
class CreateViewBorrowerGuarantorTable extends Migration
{
    ...
    public function up()
    {
        ...
        AS SELECT l.id AS id_loan,
            ...
            (((((((COALESCE(a.last_name, ''::character varying)::text || ' '::text) || COALESCE(a.mothers_last_name, ''::character varying)::text) || ' '::text) || COALESCE(a.first_name, ''::character varying)::text) || ' '::text) || COALESCE(a.second_name, ''::character varying)::text) || ' '::text) || COALESCE(a.surname_husband, ''::character varying)::text AS full_name_affiliate,
            ...
            (((((((COALESCE(s.last_name, ''::character varying)::text || ' '::text) || COALESCE(s.mothers_last_name, ''::character varying)::text) || ' '::text) || COALESCE(s.first_name, ''::character varying)::text) || ' '::text) || COALESCE(s.second_name, ''::character varying)::text) || ' '::text) || COALESCE(s.surname_husband, ''::character varying)::text AS full_name_borrower,
        ...
        UNION
         SELECT l.id AS id_loan,
            ...
            (((((((COALESCE(a.last_name, ''::character varying)::text || ' '::text) || COALESCE(a.mothers_last_name, ''::character varying)::text) || ' '::text) || COALESCE(a.first_name, ''::character varying)::text) || ' '::text) || COALESCE(a.second_name, ''::character varying)::text) || ' '::text) || COALESCE(a.surname_husband, ''::character varying)::text AS full_name_borrower,
