          ...
          'anticipo' => [
            ...
            'modalities' => [
                ...
                ['name'=>'Anticipo sector pasivo','shortened'=>'ANT-SP','requirements'=>[
                  ['name' => 'Cédula de Identidad  del (la) titular (Original y Fotocopia).','number'=>1],
                  ['name' => 'Última Boleta de Pago (Original y Fotocopia) y/o Certificado de haberes','number'=>2], //Nuevo *caso pasivo con renta de SENASIR, o AFP
          ...
          'largo' => [
            ...
            'modalities' => [
              ...
              ['name'=>'Largo Plazo con garantía personal para el sector activo y personal Adm Policial','shortened'=>'PLP-GP-SAYADM','requirements'=>[
                ['name' => 'Cédula de Identidad  del (la) titular (Original y Fotocopia).','number'=>1],
                ['name' => 'Última Boleta de Pago del(la) Titular (Original y Fotocopia) y/o Certificado de habere','number'=>2],
